...
import Micklos from './img/micklos.jpg'
        ...
        <div>
            <div className='col-12 d-flex justify-content-center'>
                <div className='row card-decks container d-flex justify-content-center'>
                    ...
                    <div className='col-lg-3 col-md-6 col-sm-12 container d-flex justify-content-center'>
                    ...
                    <div className='col-lg-3 col-md-6 col-sm-12 container d-flex justify-content-center'>
                        <div className="card m-2 mb-5">
                            ...
                            <div className="card-body">
                                ...
                                <a href="https://www.linkedin.com/in/" className='links d-flex justify-content-center'>LinkedIn</a>
                            </div>
                        </div>                        
                    </div>
                    <div className='col-lg-3 col-md-6 col-sm-12 container d-flex justify-content-center'>
                        <div className="card m-2 mb-5">
                            <img src={Micklos} className="card-img-top" alt="Micklos" />
                            <div className="card-body">
                                <h5 className="card-title d-flex justify-content-center">Micklos Rodrigues</h5>
                                <p className="card-text d-flex justify-content-center">Aluno do #TeuFuturo 2022</p>
                                <a href="mailto: micklosrodrigues10@gmail.com subject=Olá!" className='links d-flex justify-content-center'>E-mail</a>
                                <a href="https://www.linkedin.com/in/" className='links d-flex justify-content-center'>LinkedIn</a>
                            </div>
                        </div>                        
                    </div>
